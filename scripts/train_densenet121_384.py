# scripts/train_densenet121_384.py
from __future__ import annotations

import sys
from pathlib import Path

# allow "src" import when running from project root
...
IMG_SIZE = 384
BATCH_SIZE = 12          # VRAM 12GB safe start for 384 + DenseNet121
ACCUMULATE = 2           # effective batch ~ 24

# 🚀 SPEED (Windows + many JPGs)
NUM_WORKERS = 12         # 8-12 usually best; adjust if RAM/CPU limited
...
def main():
    ...
    # 🚀 speedups on RTX 4070 (Ampere-like)
    torch.backends.cuda.matmul.allow_tf32 = True
    torch.backends.cudnn.allow_tf32 = True
    torch.backends.cudnn.benchmark = True
    torch.set_float32_matmul_precision("high")  # better throughput than "medium" often

    # pos_weight must use the SAME policy + split logic as datamodule
